...
import (
	...
	"github.com/ZDragon/coredns-hot-update/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type FederationV1alpha1Interface interface {
	RESTClient() rest.Interface
	HostEntriesSlicesGetter
	HostEntriesGetter
}

// FederationV1alpha1Client is used to interact with features provided by the federation.synapse.sber group.
type FederationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FederationV1alpha1Client) HostEntriesSlices(namespace string) HostEntriesSliceInterface {
	return newHostEntriesSlices(c, namespace)
}

func (c *FederationV1alpha1Client) HostEntries(namespace string) HostEntryInterface {
	return newHostEntries(c, namespace)
}
